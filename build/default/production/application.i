...
# 15 "./MCAL_LAYER/Delay/../TIMER0/hal_timer0.h"
...
int main(void) {
    ...
    if((uint8)0X00 !=u8PassIsSetOrNotSet((uint16)0X0005)){
        lcd_4bit_send_command(&Lcd_Obj,0x01);
        ...
        _TimerDelay_ms(2000);
        lcd_4bit_send_command(&Lcd_Obj,0x01);
        lcd_4bit_send_string_data(&Lcd_Obj,"Set Pass ");
        set_cursor_4bit_mode(&Lcd_Obj,2,1);
        lcd_4bit_send_string_data(&Lcd_Obj,"The Pass :");
        ...
        while (PassCounter < (uint8)4){
            ...
            set_cursor_4bit_mode(&Lcd_Obj,2,11+PassCounter);
            lcd_4bit_send_char_data(&Lcd_Obj,(uint8)'*');
            _TimerDelay_ms(50);
            PassCounter++;
        }
        vWriteBlockOnEEPROM((uint16)0X0000,Pass,(uint8)4);
        eeprom_WriteDataByte((uint16)0X0005,(uint8)0X00);
        lcd_4bit_send_command(&Lcd_Obj,0x01);
        lcd_4bit_send_string_data(&Lcd_Obj,"Pass Saved");
        _TimerDelay_ms(1000);
        }
    else {
        BlockModeFlag=u8PassIsSetOrNotSet((uint16)0X0006);
        lcd_4bit_send_command(&Lcd_Obj,0x01);
        lcd_4bit_send_string_data(&Lcd_Obj,"Set The Pass:");
    }
    while(1){
        u8KeyPadPressed=0XFF;
        uint8 PassCounter=0;
        ...
        if(BlockModeFlag==(uint8)1){
                ...
                u8KeyPadPressed=0XFF;
                eeprom_WriteDataByte((uint16)0X0006,(uint8)0);
            }
        while (PassCounter < (uint8)4){
            u8KeyPadPressed=0XFF;
            while(u8KeyPadPressed == 0XFF){
            ...
            if((u8KeyPadPressed < '0') || (u8KeyPadPressed > '9') ){
                ...
                lcd_4bit_send_char_data(&Lcd_Obj,u8KeyPadPressed);
                _TimerDelay_ms((uint16)300);
                set_cursor_4bit_mode(&Lcd_Obj,1,14+PassCounter);
                lcd_4bit_send_char_data(&Lcd_Obj,(uint8)'*');
                _TimerDelay_ms(100);
                PassCounter++;
            }
        }
         vReadBlockOnEEPROM((uint16)0X0000,PassStored,(uint8)4);
         ...
         if((uint8)1==u8ComparePass(PassStored,Pass,(uint8)4)){
                ...
                _TimerDelay_ms(1000);
                set_cursor_4bit_mode(&Lcd_Obj,2,1);
                lcd_4bit_send_string_data(&Lcd_Obj,"Wait until The Door");
                set_cursor_4bit_mode(&Lcd_Obj,3,1);
                lcd_4bit_send_string_data(&Lcd_Obj,"Open And Close");
                dc_motor_move_right(&DC_Obj);
                _TimerDelay_ms(5000);
                dc_motor_move_left(&DC_Obj);
                _TimerDelay_ms(5000);
                dc_motor_stop(&DC_Obj);
                lcd_4bit_send_command(&Lcd_Obj,0x01);
                lcd_4bit_send_string_data(&Lcd_Obj,"Set The Pass:");
                }
                ...
                eeprom_WriteDataByte((uint16)0X0006,(uint8)1);
